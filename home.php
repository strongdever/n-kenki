...
<main id="top-page" class="main-common">
    <div class="mainview">
        ...
        <div class="right-part">
            <img class="mainviewbg" src="<?php bloginfo('template_url'); ?>/img/mainviewbg01.jpg" alt="工場の未来を動">
            <div class="thumb-imgs">
                <img class="thumb-item" src="<?php bloginfo('template_url'); ?>/img/mainviewbg11.jpg" alt="重量物移設のプロ集団">
